...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
            <div class="row">
                <center><a href="<?php echo base_url("index.php/Admin_ExportController/exportToExcel"); ?>" class="btn btn-info" role="button">Download ke Excel</a></center>
            ...
            <div class="row">
                ...
                <center>
                <form action="<?php echo base_url(); ?>index.php/Admin_NilaiController/upload"  method="post" enctype="multipart/form-data">
                    <input type="file" name="file" id="file" required accept=".xls, .xlsx" /></center>
